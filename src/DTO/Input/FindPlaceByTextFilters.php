...
class FindPlaceByTextFilters
{
    /**
     * (Required) The text string on which to search, for example: "restaurant" or "123 Main Street".
     ...
     * The Places API will return candidate matches based on this string and order the results based on their perceived relevance.
     */
    private readonly string $input;

    /**
     * (Required) The type of input. This can be one of either `textquery` or `phonenumber`.
     ...
     * See [E.164 ITU recommendation](https://en.wikipedia.org/wiki/E.164) for more information.
     */
     ...
     * If the field you want is not returned by Place Search, you can use Place Search to get a <code>place_id</code>,
     * then use that Place ID to make a Place Details request. For more information on the fields that are unavailable in a Place Search request,
     * see <a href="https://developers.google.com/maps/documentation/places/web-service/place-data-fields#places-api-fields-support">Places API fields support</a>.
     * </div>
     ...
     * See the [pricing sheet](https://cloud.google.com/maps-platform/pricing/sheet/) for more information.
     * Attributions, `html_attributions`, are always returned with every call, regardless of whether the field has been requested.
     *
     * **Basic**
     *
     ...
     * - `name`,
     * - `permanently_closed` ([deprecated](https://developers.google.com/maps/deprecations)),
     * - `photo`,
     * - `place_id`,
     * - `plus_code`,
     * - `type`,
     ...
     */
    private readonly ?string $locationBias;
